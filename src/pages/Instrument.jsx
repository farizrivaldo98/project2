...
function Instrument() {
  ...
  const fetchData = async () => {
    let response = await Axios.get("http://10.126.15.135:8002/part/instrument");
  ...
  let clickSubmit = async () => {
    ...
    let hardness = await Axios.post(
      "http://10.126.15.135:8002/part/hardness",
      data
    );
    ...
    let thickness = await Axios.post(
      "http://10.126.15.135:8002/part/thickness",
      data
    );
    var result2 = [];
    ...
    let diameter = await Axios.post(
      "http://10.126.15.135:8002/part/diameter",
      data
    );
    var result3 = [];
