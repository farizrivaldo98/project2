...
function Pareto() {
  ...
  const fetchData = async () => {
    let response1 = await axios.get("http://10.126.15.135:8001/part/line1");
    var result1 = {};
    ...
    let response2 = await axios.get("http://10.126.15.135:8001/part/line2");
    var result2 = {};
    ...
    let response3 = await axios.get("http://10.126.15.135:8001/part/line3");
    var result3 = {};
