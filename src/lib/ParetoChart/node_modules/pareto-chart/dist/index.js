...
var ParetoChart = function (_Component) {
    ...
    function ParetoChart(props) {
        ...
        _this.getChartColor = function (index$$1) {

            var colors = ['rgb(0, 192, 239, .4)',  'rgb(104,115,140, .4)', 'rgb(48, 187, 187, .4)', 'rgb(11, 120, 206, .4)', 'rgb(255, 119, 1, .4)', 'rgb(17, 17, 17, .4)', 'rgb(96, 92, 168, .4)'];
        ...
        _this.getChartBorderColor = function (index$$1) {
        ...
        _this.getSortedData = index(function (data, index$$1) {
            var selectedLegend = _this.getSelectedLegend(data, index$$1);
    ...
    createClass(ParetoChart, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            var changed = false;
            for (var index$$1 in nextProps) {
                if (JSON.stringify(nextProps[index$$1]) !== JSON.stringify(this.props[index$$1])) {
                    changed = true;
                }
            }
        ...
        value: function getSelectedLegend(data, index$$1) {
            return Object.keys(data)[index$$1];
        }
    }, {
        key: 'getChartData',
        ...
        key: 'selectDataset',
        value: function selectDataset(index$$1) {
        ...
        value: function getLegend() {
            ...
            var labelsDivs = labels.map(function (label, index$$1) {
                var labelClass = index$$1 === _this2.state.index ? 'label_' : 'labelLineThrough';
                var color = _this2.getColor(index$$1);
                return React__default.createElement(
                    'div',
                    { key: 'labels_' + label + '_' + index$$1, className: 'legendLabel', onClick: function onClick() {
                            return _this2.selectDataset(index$$1);
                        } },
        ...
        key: 'getColor',
        value: function getColor(index$$1) {
